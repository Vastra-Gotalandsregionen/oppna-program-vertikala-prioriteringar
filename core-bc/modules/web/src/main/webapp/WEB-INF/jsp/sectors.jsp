...
<div class="yui3-u-1-2 otherUser">
  <ol>
    ...
    <li>
      <img src="img/icon_alert.gif" /> Markerar ifall sektorsrådet inte kan tas bort pga att den har tillhörande prioriteringsobjekt. För muspekaren över ikonen för att få reda på hur många poster det rör sig om.
