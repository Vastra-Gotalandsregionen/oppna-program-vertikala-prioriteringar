...
@Repository
public class JpaSectorRepository extends DefaultJpaRepository<SektorRaad> implements SectorRepository {

	@Override
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SektorRaad> getTreeRoots() {
		List<SektorRaad> result = query("select o from @ o where o.parent is null order by LOWER(o.name) DESC");
