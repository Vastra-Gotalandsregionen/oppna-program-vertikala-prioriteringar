...
public interface GenerisktFinderRepository<T extends AbstractEntity<Long>> extends Repository<T, Long> {
    ...
    /**
     * Getter for strings that should be the name of the properties to use when sorting the result.
     * 
     * @return the names.
     */
