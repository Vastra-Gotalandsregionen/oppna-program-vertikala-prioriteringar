...
<div class="help-block help-block-color">
    ...
    <ol>
      <li>
          ...
          <ol>
            <li class="no-list-style"><img src="img/node-closed.png" /> Expanderar sektorsrådets nod och visar dess underråd </li>
            <li class="no-list-style"><img src="img/node-open.png" /> Stänger sektorsrådets lista över underråd </li>
